...
export const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <header
      className="fixed top-0 left-0 right-0 z-50 transition-colors duration-300 bg-[#060919]/90 border-b border-amber-500/20 shadow-xl shadow-black/50 backdrop-blur-xl"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <a
            ...
            className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl text-xs font-bold border border-amber-500/30 bg-[#0c1224] text-amber-200 hover:bg-amber-500/10 hover:border-amber-400 transition"
          ...
          <motion.a
            ...
            id="nav-quote-cta"
            className="inline-flex items-center gap-1.5 px-4 sm:px-5 py-2.5 rounded-full text-xs sm:text-sm font-black text-slate-950 shadow-lg shadow-amber-500/25 transition shrink-0 bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-500 hover:brightness-110 active:scale-95"
          >
          ...
          <button
            ...
            className="lg:hidden p-2 rounded-xl border border-amber-500/30 bg-[#0c1224] text-amber-200 hover:bg-amber-500/10 transition"
