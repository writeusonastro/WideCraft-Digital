...
const LOCAL_CLUSTERS: LocalCityCluster[] = [
  ...
  {
    id: 'unjha-patan-kadi',
    name: 'Unjha, Patan & Kadi Industrial GIDC',
    tagline: 'Global Exporters, Spice Traders & Heavy Ceramic Hubs',
    coverageAreas: [
      'Unjha APMC (World Jeera Capital)',
      'Kadi GIDC Industrial Estate',
      'Chhatral GIDC & Kalol Highway',
      'Patan City & University Area',
      'Siddhpur & Vadnagar',
      'Becharaji Auto Industrial Corridor',
    ],
    primaryKeywords: [
      'Spice Exporter Website Design Unjha',
      'Industrial B2B Google Ads Kadi & Kalol GIDC',
      'Website Designer in Patan Gujarat',
      'Ceramic Tile Manufacturer Website Design Kadi',
      'Export Inquiry Generation Agency Unjha',
      'APMC Trader Digital Catalog & WhatsApp Marketing',
      'Local SEO Company near Becharaji GIDC',
    ],
    keyIndustries: ['Jeera & Fennel Spice Export', 'Ceramics & Sanitaryware', 'Cotton Ginning & Oil Mills', 'Auto Ancillary & Engineering', 'Brass & Metal Craft'],
    localHighlight: 'Specialized international SEO & B2B lead pipelines for spice exporters and factory owners to capture buyers from UAE, USA, Europe & pan-India.',
  },
  {
    id: 'ahmedabad-metro',
    ...
    primaryKeywords: [
      ...
      'Healthcare & Clinic SEO Agency Ahmedabad',
    ],
  ...
  {
    id: 'north-gujarat',
    name: 'North Gujarat Towns (Visnagar, Palanpur & Himmatnagar)',
    tagline: 'Medical, Educational & Agricultural Regional Centers',
    coverageAreas: [
      'Visnagar (Hospital, Medical & College Belt)',
      'Palanpur (Dairy & Diamond Trading Hub)',
      'Himmatnagar (Sabarkantha Commercial Center)',
      'Idar & Modasa',
      'Deesa Agricultural Potato Hub',
      'Ambaji Pilgrim Region',
    ],
    primaryKeywords: [
      'Digital Marketing Agency Visnagar',
      'Hospital & Doctor Local SEO Visnagar',
      'Website Designer in Palanpur',
      'Google Maps 3-Pack SEO North Gujarat',
      'Education Institute Admission Ads Gujarat',
      'Lead Generation for Retail Showrooms Himmatnagar',
    ],
    keyIndustries: ['Multispecialty Hospitals & Clinics', 'Higher Education Institutes', 'Dairy & Cold Storage', 'Agri Products & Seeds', 'Jewelry & Retail Showrooms'],
    localHighlight: 'Helping doctors, educational trusts, and retail showrooms dominate Google Search when local families search for top services nearby.',
  },
  {
    ...
    coverageAreas: [
      'Surat (Ring Road, Varachha, Vesu, Adajan)',
      'Vadodara (Alkapuri, Makarpura GIDC, Manjusar)',
      'Rajkot (Aji GIDC, Metoda GIDC, Shapar)',
      'Bhavnagar & Jamnagar Brass Hub',
    ],
    primaryKeywords: [
      ...
      'Industrial Valve & Pump Website Design Rajkot',
    ],
...
const ALL_LOCAL_KEYWORDS = [
  ...
  'Website Designer near Wide Angle Mehsana',
  'Digital Marketing Agency Ahmedabad',
  'Website Designer SG Highway Ahmedabad',
  'Shopify E-Commerce Developer Gujarat',
  'B2B Manufacturing Lead Gen Agency Gujarat',
  'Spice Exporter Website Design Unjha',
  ...
  'Hospital & Doctor Local SEO Mehsana',
  'High-Speed Website Developer near me',
  'E-Commerce WhatsApp Funnel Automation',
  'PPC Lead Generation Agency Ahmedabad',
  'Top Ranked Digital Agency North Gujarat',
];
